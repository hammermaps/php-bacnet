...
void php_bacnet_security_stats_to_array(php_bacnet_security *security, bool include_sources,
										bool reset, zval *result);
bool php_bacnet_security_accept(php_bacnet_security *security, const BACNET_ADDRESS *source,
								const uint8_t *pdu, uint16_t pdu_len, php_bacnet_packet_kind *kind);
void php_bacnet_security_malformed(php_bacnet_security *security, const BACNET_ADDRESS *source);
void php_bacnet_security_queue_overflow(php_bacnet_security *security);
bool php_bacnet_security_is_duplicate_write(php_bacnet_security *security,
											const BACNET_ADDRESS *source, const uint8_t *apdu,
											uint16_t apdu_len);
void php_bacnet_security_record_write(php_bacnet_security *security, const BACNET_ADDRESS *source,
