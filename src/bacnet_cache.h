...
void php_bacnet_cache_invalidate(php_bacnet_cache *cache,
    php_bacnet_cache_partition partition, const char *scope);
void php_bacnet_cache_refresh(php_bacnet_cache *cache,
    php_bacnet_cache_partition partition, const char *scope);
...
void php_bacnet_cache_get_stats(php_bacnet_cache *cache, bool include_entries,
    bool reset, zval *return_value);
