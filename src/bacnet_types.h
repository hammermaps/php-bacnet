...
static inline php_bacnet_object_identifier_obj *php_bacnet_oid_from_obj(zend_object *obj) {
	return (php_bacnet_object_identifier_obj *)((char *)obj -
												XtOffsetOf(php_bacnet_object_identifier_obj, std));
}
...
static inline php_bacnet_bitstring_obj *php_bacnet_bitstring_from_obj(zend_object *obj) {
	return (php_bacnet_bitstring_obj *)((char *)obj - XtOffsetOf(php_bacnet_bitstring_obj, std));
}
...
static inline php_bacnet_date_obj *php_bacnet_date_from_obj(zend_object *obj) {
	return (php_bacnet_date_obj *)((char *)obj - XtOffsetOf(php_bacnet_date_obj, std));
}
...
static inline php_bacnet_time_obj *php_bacnet_time_from_obj(zend_object *obj) {
	return (php_bacnet_time_obj *)((char *)obj - XtOffsetOf(php_bacnet_time_obj, std));
}
...
static inline php_bacnet_value_obj *php_bacnet_value_from_obj(zend_object *obj) {
	return (php_bacnet_value_obj *)((char *)obj - XtOffsetOf(php_bacnet_value_obj, std));
}
...
static inline php_bacnet_objectref_obj *php_bacnet_objectref_from_obj(zend_object *obj) {
	return (php_bacnet_objectref_obj *)((char *)obj - XtOffsetOf(php_bacnet_objectref_obj, std));
}
...
static inline php_bacnet_server_obj *php_bacnet_server_from_obj(zend_object *obj) {
	return (php_bacnet_server_obj *)((char *)obj - XtOffsetOf(php_bacnet_server_obj, std));
}
